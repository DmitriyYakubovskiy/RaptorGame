    ...
    {        
       ...
       protected void PeacefulLogics()
        ...
        void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawWireCube(new Vector3(gameObject.transform.position.x + (IsFlip == true ? -sizeCheckingWall.x : sizeCheckingWall.x), gameObject.transform.position.y + +sizeCheckingWall.y, 1), new Vector3(sizeCheckingWall.x, sizeCheckingWall.y, 1));

            Gizmos.color = Color.gray;
            Gizmos.DrawWireSphere(new Vector2(gameObject.transform.position.x, gameObject.transform.position.y + RadiusCheckGround / 2), RadiusCheckGround + 0.2f);
        }
    }
}
